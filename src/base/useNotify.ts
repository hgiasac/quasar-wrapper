...
export type QNotifyOptions = {
   ...
   */
  badgeStyle?: string[] | string | LooseDictionary;
  /**
   * Class definitions to be attributed to the badge
   */
  badgeClass?: string[] | string | LooseDictionary;
  /**
   ...
   */
  progressClass?: string[] | string | LooseDictionary;
  /**
...
export const notify = (options: QNotifyOptions) => {
  return Notify.create(options);
};

const notifyDefault = (
  options: string | QNotifyOptions,
  defaultOptions: QNotifyOptions
) => {
...
export const notifyPositive = (options: string | QNotifyOptions) => {
...
export const notifyNegative = (options: string | QNotifyOptions) => {
  return notifyDefault(options, {
    color: "negative",
    position: "bottom",
  });
...
export const notifyInfo = (options: string | QNotifyOptions) => {
  return notifyDefault(options, {
    color: "info",
    position: "bottom",
  });
...
export const notifyPrimary = (options: string | QNotifyOptions) => {
  return notifyDefault(options, {
    color: "primary",
    position: "bottom",
  });
...
export const notifySecondary = (options: string | QNotifyOptions) => {
  return notifyDefault(options, {
    color: "secondary",
    position: "bottom",
  });
...
export const notifyAccent = (options: string | QNotifyOptions) => {
  return notifyDefault(options, {
    color: "accent",
    position: "bottom",
  });
...
export const notifyDark = (options: string | QNotifyOptions) => {
  return notifyDefault(options, {
    color: "dark",
    position: "bottom",
  });
...
export const notifyWarning = (options: string | QNotifyOptions) => {
  return notifyDefault(options, {
    color: "warning",
    position: "bottom",
  });
